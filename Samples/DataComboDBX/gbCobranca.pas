...
uses
   Windows, classes, SysUtils, Graphics, extctrls, Dialogs, QRPDFFilt, QRWebFilt, QRExport
...
uses gbCob001, gbCob021, gbCob033, gbCob038, gbCob104, gbCob151, gbCob237, gbCob244, gbCob275, gbCob291, gbCob320, gbCob341, gbCob347, gbCob353, gbCob389, gbCob394, gbCob399, gbCob409, gbCob422, gbCob479, gbCob745, gbCob041;
...
begin
   ...
   begin
      ...
      AAgenciaCodigoCedente := StringReplace(AAgenciaCodigoCedente, Copy(AAgenciaCodigoCedente,1,5), '', [rfReplaceAll, rfIgnoreCase]);
      ...
      txtEnderecoCedente.Caption := AnsiUpperCase(Sacado.Endereco.Complemento);
      ...
      NossoNumeroBoleto:= ANossoNumero; //Declarado para pegar o número do boleto
      txtUsoBanco.Caption := '';
      ...
      txtSacadoRuaNumeroComplemento.Caption := AnsiUpperCase(Sacado.Endereco.Rua);
      ...
      lblcurso1.Caption := Cedente.Endereco.Email;
      ...
      txtEnderecoCedente2.Caption := AnsiUpperCase(Sacado.Endereco.Complemento);
      ...
      txtSacadoRuaNumeroComplemento2.Caption := AnsiUpperCase(Sacado.Endereco.Rua);
      ...
      lblcurso2.Caption := Cedente.Endereco.Email;
      ...
      txtEnderecoCedente3.Caption := AnsiUpperCase(Sacado.Endereco.Complemento);
      ...
      txtSacadoRuaNumeroComplemento3.Caption := AnsiUpperCase(Sacado.Endereco.Rua);
      ...
      lblcurso3.Caption := Cedente.Endereco.Email;
...
begin
   ...
   TRY
      ...
      //ABoleto.ExportToFilter(TQRPDFDocumentFilter.Create('c:\teste1.pdf'));
      ABoleto.Preview;
      {ABoleto.ExportToFilter(TQRPDFDocumentFilter.Create('c:\teste2.pdf'));
      ABoleto.ExportToFilter(TQRGHTMLDocumentFilter.Create('c:\teste.html'));
      ABoleto.ExportToFilter(TQRRTFExportFilter.Create('c:\teste.rtf'));}
      ABoleto.Free;
   EXCEPT
      ABoleto.Free;
      Raise;
